...
enum Item: Hashable{
    ...
    static let promotedApps: [Item] = [
        .app(App(promotedHeadline: "Now Trending", title: "Game Title", subtitle: "3.99", price: 3.99)),
    ...
    static let popularApps: [Item] = [
        .app(App(promotedHeadline: nil, title: "Pepr", subtitle: "$ 4.99", price: nil)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: 2.99)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: nil)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: 9.99)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: nil)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: nil)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: 6.99)),
        .app(App(promotedHeadline: nil, title: "Game Title", subtitle: "$ 4.99", price: nil)),
    ]
