...
class ViewController: UIViewController {
    ...
    func createLayout() -> UICollectionViewLayout {
        ...
        // This closure will be called when layour needs info about the section
            //MARK: HEADER ITEM
            ...
            //MARK: LINE ITEM
            let lineItemHeight = 1 / layoutEnvironment.traitCollection.displayScale // setting the display scale (horizontal / vertical)
